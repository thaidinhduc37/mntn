...
const newsData = [
  {
    ...
    content:
      "Trường Mầm non Tuổi Ngọc thông báo tuyển sinh cho năm học mới. Phụ huynh có thể đăng ký trực tiếp tại trường hoặc liên hệ qua số điện thoại để được tư vấn chi tiết về chương trình học, học phí và các hoạt động giáo dục.",
    category: "Thông báo",
    date: "2024-11-15",
  ...
  },
  {
    ...
    content:
      "Chương trình văn nghệ chào mừng ngày Nhà giáo Việt Nam với sự tham gia của các em học sinh và phụ huynh. Chương trình bao gồm các tiết mục ca hát, múa và trao tặng hoa tới các cô giáo.",
    category: "Hoạt động",
    date: "2024-11-10",
  ...
  },
  {
    ...
    content:
      "Thực đơn được lập theo khuyến nghị của Viện Dinh dưỡng Quốc gia, đảm bảo đầy đủ chất dinh dưỡng cho trẻ. Thực đơn bao gồm các món ăn đa dạng, cân bằng dinh dưỡng phù hợp với từng độ tuổi.",
    category: "Dinh dưỡng",
    date: "2024-11-05",
  ...
  },
  {
    ...
    content:
      "Lịch khám sức khỏe định kỳ 6 tháng/lần cho các em học sinh tại Trung tâm Y tế xã Quảng Phú. Việc khám sức khỏe định kỳ giúp theo dõi sự phát triển của trẻ và phát hiện sớm các vấn đề sức khỏe.",
    category: "Sức khỏe",
    date: "2024-11-01",
  ...
  },
  {
    ...
    content:
      "Các hoạt động ngoại khóa đa dạng giúp trẻ phát triển toàn diện. Bao gồm: vẽ tranh, làm đồ chơi từ nguyên liệu tái chế, học hát dân ca địa phương và tham quan các địa điểm lịch sử gần trường.",
    category: "Hoạt động",
    date: "2024-10-28",
...
const programs = [
  {
    ...
    description:
      "Chăm sóc và giáo dục trẻ nhỏ với sự quan tâm đặc biệt đến sự phát triển thể chất và tinh thần.",
    features: [
  ...
  },
  {
    ...
    ageRange: "3-4 tuổi",
    description:
      "Phát triển toàn diện các kỹ năng cơ bản, chuẩn bị cho bé bước vào giai đoạn học tập cao hơn.",
    features: [
  ...
  },
  {
    ...
    ageRange: "4-5 tuổi",
    description:
      "Chuẩn bị toàn diện cho trẻ bước vào lớp 1, tập trung phát triển tư duy và kỹ năng học tập.",
    features: [
...
const facilitiesData = [
  ...
  },
  {
    ...
    name: "Sân chơi",
    description:
      "Khu vực vui chơi ngoài trời an toàn với nhiều thiết bị đa dạng",
  ...
  },
  {
    ...
    name: "Phòng ăn",
    description:
      "Không gian ăn uống sạch sẽ, đảm bảo vệ sinh an toàn thực phẩm",
    features: [
      "Bàn ăn phù hợp",
      "Bếp hiện đại",
      "Tủ lạnh bảo quản",
...
const heroSlides = [
  ...
  },
  {
    ...
    description:
      "Áp dụng chương trình giáo dục mầm non theo định hướng phát triển năng lực",
  ...
  },
  {
    ...
    description:
      "Không gian học tập thoáng mát, an toàn với đầy đủ trang thiết bị hiện đại",
